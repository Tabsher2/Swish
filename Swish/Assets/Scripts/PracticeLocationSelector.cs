...
public class PracticeLocationSelector : MonoBehaviour
{
    ...
    {
        if (slideCameraDown)
            PracticeCameraController.MoveToSelectedSpot(Camera.main.transform.position, Camera.main.transform.eulerAngles, cameraLocation, cameraAngle);

        if (allowSelection && displayInitialBanner && !PracticeController.slideCameraUp)
        {
    ...
    private void OnMouseDown()
    {
        ...
        if (allowSelection && !PracticeController.slideCameraUp)
        {
